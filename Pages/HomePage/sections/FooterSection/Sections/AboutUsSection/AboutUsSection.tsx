...
const AboutUsSection = () => {
    return (
      <div className="w-[16%] h-[20vh]  flex flex-col    justify-end items-end bg-blue-600">
        <div className="w-[80%] min-h-[6vh] flex flex-row justify-center items-center text-center  gap-4 opacity-100 bg-amber-800 ml-11">
          {/* company name */}
          <div className="w-[88%] h-[5vh] bg-wight opacity-100 flex mt-[10%] justify-end bg-red-500">
            <span className="font-beiruti font-semibold text-2xl leading-none text-black87 ">A2Z  شركة </span>
          </div>
          {/* logo */}
          <div className="w-[50%] h-[100%] opacity-100 rotate-0 bg-slate-600">
            <img
