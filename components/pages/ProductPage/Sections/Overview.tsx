      ...
      <section className="bg-white max-w-[95%] mx-auto rounded-2xl border shadow-sm p-4 sm:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div className="lg:col-span-4">
            ...
            >
              {/* ✅ FIX: key={currentImageIndex} forces CustomImage to remount when
                  the image changes, preventing stale internal state from caching
                  the first src value and ignoring subsequent prop updates. */}
              <CustomImage
